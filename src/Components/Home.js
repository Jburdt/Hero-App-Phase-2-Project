...
const Home = () => {
  return (
    <div className='welcome'> 
      <h1>Welcome to the Avengers team!</h1>
      <p>We have some heros already added for you to help you on your mission. Click the Add New Hero link to add more avengers! </p>
      <p>Marvel Comics (or simply Marvel) is an American comic book publisher and primary imprint of Marvel Worldwide Inc. (formerly Marvel Publishing, Inc. and Marvel Comics Group), part of Marvel Entertainment. In 2009, The Walt Disney Company acquired the parent company.
